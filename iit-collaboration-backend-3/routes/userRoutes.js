...
import { deleteMyAccount, deleteUser, forgetPassword, getAllUsers, getIdByMail, getMe, getUserDetails, login, logout, myLikedRepos, register, resetPassword, updateUserDetails, updateUserProfilePic } from '../controllers/userController.js';
...
router.route("/mylikedrepos").get(isAuthenticated, myLikedRepos);
router.route("/getidbymail").get(isAuthenticated, getIdByMail);
